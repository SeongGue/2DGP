...
# r_sound = "sound"
# r_txt = "txt"
# resources = "image font sound txt".split()

resource_font = ['./resource/font/' + file_name for file_name in os.listdir('./resource/font/')]
resource_image = ['./resource/image/' + file_name for file_name in os.listdir('./resource/image/')]
resource_sound = ['./resource/sound/' + file_name for file_name in os.listdir('./resource/sound/')]
resource_txt = ['./resource/txt/' + file_name for file_name in os.listdir('./resource/txt/')]
...
setup(name="name",
      windows=[mygame],
      data_files=[('./resource/font/', resource_font), (sdl_folder, sdl_dlls)] + [('./resource/image/', resource_image), (sdl_folder, sdl_dlls)] +
                 [('./resource/sound/', resource_sound), (sdl_folder, sdl_dlls)] + [('./resource/txt/', resource_txt), (sdl_folder, sdl_dlls)], # copy resource to '.' folder
      zipfile=None,
